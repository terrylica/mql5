...
// Define a global variable to track the last bar time
...
//--- final selection of extreme points for ZigZag
   ...
   // Handle non-repainting option and confirmation display
   if(InpNoRepaint)
     {
      ...
      for(i=rates_total-1; i>=0 && extreme_count < 3; i--)
        {
      ...
      // If we have at least two extremes found
      if(last_extreme_pos >= 0 && prev_extreme_pos >= 0)
        {
         ...
         for(i=prev_extreme_pos+1; i<last_extreme_pos; i++)
           {
